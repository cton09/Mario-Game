...
p2 = gamebox.from_color(20, 400, "red", 15, 100)
p1 = gamebox.from_color(780, 400, "yellow", 15, 100)
...
def tick(keys):
    ...
    camera.clear("black")
    camera.draw(gamebox.from_text(300, 50, str(p2_score), "Arial", 50, "Red", True))
    camera.draw(gamebox.from_text(500, 50, str(p1_score), "Arial", 50, "Yellow", True))
